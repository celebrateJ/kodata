    ...
    <div class="work-content-wrapper">
      <div class="content-inner" ref="contentInner">
        ...
        <ChatIntro 
          v-if="isIntro" 
          symbolType="ai"
          :optList="tempIntroOptList"
        >
          <template #introTitle>업무지식 챗봇</template>
          <template #introDesc>
            사내 문서를 기반으로 답변합니다. 제공되는 답변은 참고용이며, 정확한 내용은 원본 문서를 확인해 주세요
            <br>업무 분야를 선택하면 더 정확한 답변을 받을 수 있습니다.
          </template>
        </ChatIntro>
